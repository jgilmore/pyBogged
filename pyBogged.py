...
class gtkbogged:
	def startgame(self, widget):
		...
		if self.options_list["fivebyfiveoriginal"].get_active():
			...
			#ABCDEFGHIJKLMNOPQRSTUVWXYZ  lowscore, highscore, penalties, word freq penalties,average, overall
			#7144B133412544541496412141  64 261 0 25970 149.0 3875.0
			self.bogged=bogged("SGQEPIAEPXKCUALZEBNSYCLYOGTNDEUOLHRYSETMESMEEETIEAIDAWDETYJUSRHNSNTFAMICOSLWLTUSHCRAMKDRPGVOAOPS")
			...
			#ABCDEFGHIJKLMNOPQRSTUVWXYZ
			#D447*342611558741FFA412111
			self.bogged=bogged("ELRSNEJNCWEEBTFEONTPEESDMEATNEUAESIODRRESOISASRIASTENTOERTZTRRERESODEESIXEERUATAEPOKYRUOGADASRCSARPHELAAMISUNCDGEBNSLBFPGAMFGWRDLCDEMETHTIRQVEESBRLASM")
			#ABCDEFGHIJKLMNOPQRSTUVWXYZ
			#B43AJ222711865D819D9641131
			self.bogged=bogged("OOAPEVDPOMQAEETDARNOOEMKDECLEDLASELEAEOPVPYAURIISRALUNVYHSDOGEMTOPDACEABEGPELMLUSTSOMSIDSSDTRNTEEJIRREESDULSMSPTBEIULECRNAOZISUXONOBDITVSBTWPOFYTRHAFR")
		else:
